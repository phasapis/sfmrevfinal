...
//				simulationService.insertService(projectSimulationTO);
				...
				if (projectName != null || !"".equals(projectName)) {
					addInfoMessage(
							"Good!",
							"Try to configure firstly the \"Mesh\" and then \"Material Property\". Run this new simulation through \"Save All\" and \"Run\".");
					projectSimulationEB.getProjectSimulationTO()
	...
	public void save() {
		try {
			if (solverSetupEB != null
				...
				addInfoMessage("Done!", "Project saved successfully!");
