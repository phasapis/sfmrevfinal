...
public class LoadParametersController extends GenericMB{
	...
	static {
		...
		paramsForMesh.put("Head Model",Arrays.asList("Material 1", "Material 2"));
                ...
                paramsForMesh.put("Cochlea Coiled Model Longitudinal Coupling",Arrays.asList("Frequency",  "Fluid", "Youngs Modulus", "Damping", "Function", "External"));
                ...
                paramsForMesh.put("Coupled Model",Arrays.asList("Pressure coupled model", "Frequency", "Basilar membrane coupled model", "Coupled model oval window", "Coupled model Fluid", "Analysis Type"));
	}
	...
	public void fileUploadListener(FileUploadEvent event){
		try {
			...
			if(fileUpload!=null){
				...
				blockTabs(UPLOAD);
				addInfoMessage("Info","File uploaded successfully!");
			}
		} catch (Exception e) {
